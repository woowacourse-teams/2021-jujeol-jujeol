...
public enum DrinkTestContainer {
    OB(new AdminDrinkRequest("오비", "OB", 8.5, null, "BEER",
            "맥주의 청량감이 느껴지는 맥주이다.")),
    TIGER_LEMON(new AdminDrinkRequest("타이거 라들러 레몬", "Tiger_Lemon", 4.5,
            null, "BEER", "레몬맛이 느껴지는 맥주이다.")),
    STELLA(new AdminDrinkRequest("스텔라", "stella", 5.5,
            null, "BEER", "스텔라만의 맛이 느껴지는 맥주이다.")),
    KGB(new AdminDrinkRequest("KGB", "", 3.5, null, "BEER",
            "KGB는 맥주가 아니다.")),
    ESTP(new AdminDrinkRequest("ESTP", "", 7.5, null,
            "BEER", "ESTP 맛이 나는 맥주이다.")),
    TIGER_RAD(new AdminDrinkRequest("타이거 라들러 자몽", "Tiger_Rad", 9.5,
            null, "BEER", "라드 맛이 나는 맥주이다.")),
    TSINGTAO(new AdminDrinkRequest("칭따오", "TSINGTAO", 12.0,
            null, "BEER", "양꼬치와 잘어울리는 맥주이다.")),
    APPLE(new AdminDrinkRequest("애플", "Apple", 8.2, null,
            "BEER", "사과맛이 나는 맥주이다.")),
