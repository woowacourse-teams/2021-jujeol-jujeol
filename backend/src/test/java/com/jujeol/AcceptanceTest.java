...
public class AcceptanceTest {
    ...
    protected void 예외_검증(JujeolExceptionDto jujeolExceptionDto, ExceptionCodeAndDetails invalidDrinkName) {
        assertThat(jujeolExceptionDto.getCode()).isEqualTo(INVALID_DRINK_NAME.getCode());
        assertThat(jujeolExceptionDto.getMessage()).isEqualTo(INVALID_DRINK_NAME.getMessage());
    }
}
