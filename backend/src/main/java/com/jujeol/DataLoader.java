...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Drink kgb = Drink.create("KGB 레몬", "KGB Lemon", 5.0, createFilePath("kgb"), 0.0, BEER,
                "이 음료는 맥주이다.");
        Drink efes = Drink
                .create("에페스", "EFES", 5.0, createFilePath("efes"), 0.0, BEER, "이 음료는 맥주이다.");
        ...
        final List<Drink> drinks_spread = Arrays.asList(
                ...
                Drink.create("제주 거멍 에일", "Jeju Geomeong Ale", 4.3,
                        createFilePath("Jeju_Geomeong_Ale"), 0.0, BEER, "이 음료는 맥주이다."),
                ...
                Drink.create("처음처럼", "cheo-um-cheo-rum Soju", 16.5,
                        createFilePath("cheo_um_cheo_rum_soju"), 0.0, SOJU, "이 술은 소주이다."),
                Drink.create("자몽에이슬", "jamong-eh-i-sul-soju", 13.0,
                        createFilePath("jamong_eh_i_sul_soju"), 0.0, SOJU, "이 술은 소주이다."),
                Drink.create("참이슬 오리지날", "charm-i-sel-soju", 20.1,
                        createFilePath("charm_i_sel_original_soju"), 0.0, SOJU, "이 술은 소주이다."),
                ...
                Drink.create("탈로 프리미티보 디 만두리아", "Talo Primitivo Di Manduria", 14.0,
                        createFilePath("Talo_Primitivo_Di_Manduria"), 0.0, WINE, "이 술은 와인이다."),
                Drink.create("킴 크로포드, 피노 그리", "Kim Crawford, Pinot Gris", 13.0,
                        createFilePath("Kim_Crawford_Pinot_Gris"), 0.0, WINE, "이 술은 와인이다."),
                ...
                Drink.create("T7 까베르네 소비뇽", "T7 Cabernet Sauvignon", 13.0,
                        createFilePath("T7_Cabernet_Sauvignon"), 0.0, WINE, "이 술은 와인이다."),
                ...
                Drink.create("그란 띠에라 비노 블랑코", "Gran Tierra vino blanco", 10.5,
                        createFilePath("Gran_Tierra_vino_blanco"), 0.0, WINE, "이 술은 와인이다."),
                Drink.create("비냐 란자 틴토", "VINA LANZAR Tinto", 11.5,
                        createFilePath("VINA_LANZAR_Tinto"), 0.0, WINE, "이 술은 와인이다."),
                Drink.create("빈야드 샤도네이", "Vineyards Chardonnay", 13.0,
                        createFilePath("Vineyards_Chardonnay"), 0.0, WINE, "이 술은 와인이다."),

                // 막걸리
                Drink.create("느린마을 막걸리", "Slow City Makgeolli", 6.0,
                        createFilePath("slowbrew_makgeulli"), 0.0, MAKGEOLLI, "이 술은 막걸리다."),
                ...
                Drink.create("관악산 생막걸리", "Gwanak Mountain Makgeolli", 6.0,
                        createFilePath("Gwanak_Mountain_Makgeolli"), 0.0, MAKGEOLLI, "이 술은 막걸리다."),
                Drink.create("국순당생막걸리", "Guksundang Makgeolli", 6.0,
                        createFilePath("Guksundang_Makgeolli"), 0.0, MAKGEOLLI, "이 술은 막걸리다."),
                ...
                Drink.create("소백산 막걸리", "Sobaeksan Makgeolli", 6.0,
                        createFilePath("Sobaeksan_Makgeolli"), 0.0, MAKGEOLLI, "이 술은 막걸리다."),
                Drink.create("대잎 동동주", "Bamboo Leaf Dongdongju", 6.0,
                        createFilePath("Bamboo_Leaf_Dongdongju"), 0.0, MAKGEOLLI, "이 술은 막걸리다."),
                ...
                Drink.create("스카치 블루 21년", "Scotch Blue 21years old", 40.0,
                        createFilePath("Scotch_Blue_21years_old"), 0.0, YANGJU, "이 술은 양주이다."),
                Drink.create("까뮤XO 엘레강스", "Camus XO ELECANCE", 40.0,
                        createFilePath("Camus_XO_ELECANCE"), 0.0, YANGJU, "이 술은 양주이다."),
                ...
                Drink.create("섹스 온 더 비치", "Sex on the beach", 0.0, createFilePath("sexonthebeach"),
                        0.0, COCKTAIL, "이 술은 칵테일이다."),
                Drink.create("캘리포니아 레모네이드", "California Lemonade", 0.0,
                        createFilePath("calfornialemonade"), 0.0, COCKTAIL, "이 술은 칵테일이다."),
                ...
                Drink.create("좋은데이 민트초코", "jot-eun-day-mint-choco", 12.5,
                        createFilePath("jo_eun_day_mint_choco"), 0.0, ETC, "이 술은 기타 술이다.")
    ...
    private List<String> createFilePath(String drinkName) {
        String smallFilePath =
                "https://dmaxaug2ve9od.cloudfront.net/w_200/" + drinkName + "_w200.png";
        String mediumFilePath =
                "https://dmaxaug2ve9od.cloudfront.net/w_400/" + drinkName + "_w400.png";
        String largeFilePath =
                "https://dmaxaug2ve9od.cloudfront.net/w_600/" + drinkName + "_w600.png";
