...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Drink Data
        Drink stella = Drink.create("스텔라", "stella", 5.5, "stella_artois.png", Category.BEER);
        Drink kgb = Drink.create("KGB", "", 3.5, "kgb.png", Category.BEER);
        Drink efes = Drink.create("EFES", "",7.5, "efes.png", Category.BEER);
        Drink tiger_rad = Drink.create("타이거 라들러 자몽", "Tiger_Rad", 9.5, "tiger_raddler_grapefruit.png", Category.BEER);
        Drink tsingtao = Drink.create("칭따오", "TSINGTAO", 12.0, "tsingtao.png", Category.BEER);
        Drink gom_pyo = Drink.create("곰표", "gom_pyo", 8.2, "gom_pyo.png", Category.BEER);
        Drink ob = Drink.create("오비", "OB", 85.0, "ob_lager.png", Category.BEER);
        Drink tigerLemon = Drink.create("타이거 라들러 레몬", "Tiger_Lemon", 4.5, "tiger_raddler_lemon.png", Category.BEER);
