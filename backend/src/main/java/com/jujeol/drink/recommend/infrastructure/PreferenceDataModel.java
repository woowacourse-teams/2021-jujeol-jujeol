...
public class PreferenceDataModel implements DataModel {
    ...
    public int getNumUsersWithPreferenceFor(long itemID) {
        return (int) userItems.stream().collect(Collectors.groupingBy(Preference::getUserID))
                .values()
                .stream()
    ...
    public int getNumUsersWithPreferenceFor(long itemID1, long itemID2) throws TasteException {
        long count = userItems.stream().collect(Collectors.groupingBy(Preference::getUserID))
                .values()
                .stream()
    ...
    public void setPreference(long userID, long itemID, float value) throws TasteException {
        userItems.stream().filter(userItem -> (userItem.getUserID() == userID
                && userItem.getItemID() == itemID))
    ...
    public void removePreference(long userID, long itemID) {
        userItems.removeIf(
                userItem -> userItem.getItemID() == itemID && userItem.getUserID() == userID);
    }
