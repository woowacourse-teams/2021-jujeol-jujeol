...
public class DrinkListResponse {
    ...
    @Builder
    public DrinkListResponse(Long id, String name, String englishName, Double alcoholByVolume, ImageResponse imageResponse, CategoryResponse category, String description, double preferenceRate, double preferenceAvg, double expectedPreference) {
        this.id = id;
        this.name = name;
